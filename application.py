...
@application.route('/')
def initial():
    return "Bem vindo a APIecommerce!"
...
@application.route('/api/products/add', methods=["POST"])  #methods se nao colocar ele nao vai limitar, mas e uma boa pratica coloca
@login_required
def add_product():
    data = request.json
